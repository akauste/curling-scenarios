...
for(let i=1; i < 9; i++) {
    ...
    initialState.stones['r'+i] = { x: -183+i*16, y: -183-38, id:'r'+i, type: 'stone', visible: true, num: i, team: 1 };
    initialState.stones['y'+i] = { x: 183-i*16, y: -183-38, id:'y'+i, type: 'stone', visible: true, num: i, team: 2 };
